...
class App extends Component {
  ...
  consultarApi = () => {
    ...
    .then(resultado => this.setState({ imagenes : resultado.hits }))//saco los datos de imagenes de la api y los guardo en el state
  }
//funcion para buscar y paginar automaticamente en 1 
